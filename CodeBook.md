...
(There are two subsets: one of them,with 2947 people, –test- is defined in that column)|	2947*1|
	...
	2947*1
UCI/HAR Dataset/train|	subject_train.txt|	1 column, with the label of the person who did the activity in one observation and was selected for the train subset asd There are two subsets: one of them, with 7352 people, –train- is defined in that column |	7352*1
